            ...
            for val_action in val_actions:
                ...
                if action_type == 'Map':
                    ...
                    if t_value is not None:
                        ...
                        # this is not a join but a regular map
                        val_el = get_by_tag(val_action, 'value')[0]
                        res = get_vars_from_value(val_el)
                        if res is not None:
                            accum = ()
