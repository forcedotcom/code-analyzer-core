...
public class CSSNotInStaticResourcesApexStylesheet extends AbstractVfRule {
    public static final String APEX_STYLESHEET = "apex:stylesheet";
    public static final String CSS_STATIC_RESOURCE_VIOLATION_MESSAGE = "CSS Should be loaded from static resources";
    ...
    public Object visit(ASTElement node, Object data) {
        if (!APEX_STYLESHEET.equalsIgnoreCase(node.getName())) {
            return data;
        }
    ...
    private void handleExpression(ASTAttributeValue node, Object data) {
        ...
        if (firstExpressionIdentifier.getClass() == ASTIdentifier.class) {
                ...
                firstExpressionIdentifier.getImage().compareToIgnoreCase(RESOURCE_IDENTIFIER) == 0)
            {
                ...
                asCtx(data).addViolationWithMessage(node, CSS_STATIC_RESOURCE_VIOLATION_MESSAGE);
            }
        }
    }
