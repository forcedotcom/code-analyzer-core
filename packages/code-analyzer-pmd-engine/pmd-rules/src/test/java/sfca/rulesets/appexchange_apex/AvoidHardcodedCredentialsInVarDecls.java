...
public class AvoidHardcodedCredentialsInVarDecls extends SimpleAggregatorTst {
	@Override
	protected void setUp() {
		...
		//		"resources/sfca/rulesets/appexchange_apex/xml/AvoidHardcodedCredentialsInVarDecls.xml"
		addRule("sfca/rulesets/AppExchange_apex.xml", "AvoidHardcodedCredentialsInVarDecls");
	}
}
