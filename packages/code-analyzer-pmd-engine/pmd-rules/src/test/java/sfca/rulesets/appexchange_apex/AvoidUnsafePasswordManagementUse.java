...
public class AvoidUnsafePasswordManagementUse extends SimpleAggregatorTst {
	@Override
	protected void setUp() {
		...
		//		"resources/sfca/rulesets/appexchange_apex/xml/AvoidUnsafePasswordManagementUse.xml"
		addRule("sfca/rulesets/AppExchange_apex.xml", "AvoidUnsafePasswordManagementUse");
	}
}
