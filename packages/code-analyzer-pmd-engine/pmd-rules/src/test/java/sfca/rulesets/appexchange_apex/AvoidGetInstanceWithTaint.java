...
public class AvoidGetInstanceWithTaint extends SimpleAggregatorTst {
	@Override
	protected void setUp() {
		...
		//		"resources/sfca/rulesets/appexchange_apex/xml/AvoidGetInstanceWithTaint.xml"
		addRule("sfca/rulesets/AppExchange_apex.xml", "AvoidGetInstanceWithTaint");
	}
}
