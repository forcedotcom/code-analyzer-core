...
public class AvoidChangeProtectionUnprotected extends SimpleAggregatorTst {
	@Override
	protected void setUp() {
		...
		//		"resources/sfca/rulesets/appexchange_apex/xml/AvoidChangeProtectionUnprotected.xml"
		addRule("sfca/rulesets/AppExchange_apex.xml", "AvoidChangeProtectionUnprotected");
	}
}
