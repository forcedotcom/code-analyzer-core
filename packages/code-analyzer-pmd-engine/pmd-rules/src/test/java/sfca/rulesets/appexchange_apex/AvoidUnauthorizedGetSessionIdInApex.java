...
public class AvoidUnauthorizedGetSessionIdInApex extends SimpleAggregatorTst {
	@Override
	protected void setUp() {
		...
		//		"resources/sfca/rulesets/appexchange_apex/xml/AvoidUnauthorizedGetSessionIdInApex.xml"
		addRule("sfca/rulesets/AppExchange_apex.xml", "AvoidUnauthorizedGetSessionIdInApex");
	}
}
