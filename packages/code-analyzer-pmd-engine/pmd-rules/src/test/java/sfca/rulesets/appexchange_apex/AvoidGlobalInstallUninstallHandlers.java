...
public class AvoidGlobalInstallUninstallHandlers extends SimpleAggregatorTst {
	@Override
	protected void setUp() {
		...
		//		"resources/sfca/rulesets/appexchange_apex/xml/AvoidGlobalInstallUninstallHandlers.xml"
		addRule("sfca/rulesets/AppExchange_apex.xml", "AvoidGlobalInstallUninstallHandlers");
	}
}
