...
public class AvoidHardcodedCredentialsInVarAssign extends SimpleAggregatorTst {
	@Override
	protected void setUp() {
		...
		//		"resources/sfca/rulesets/appexchange_apex/xml/AvoidHardcodedCredentialsInVarAssign.xml"
		addRule("sfca/rulesets/AppExchange_apex.xml", "AvoidHardcodedCredentialsInVarAssign");
	}
}
