...
public class AvoidHardcodedCredentialsInSetPassword extends SimpleAggregatorTst {
	@Override
	protected void setUp() {
		...
		//		"resources/sfca/rulesets/appexchange_apex/xml/AvoidHardcodedCredentialsInSetPassword.xml"
		addRule("sfca/rulesets/AppExchange_apex.xml", "AvoidHardcodedCredentialsInSetPassword");
	}
}
