...
public class AvoidHardcodedCredentialsInHttpHeader extends SimpleAggregatorTst {
	@Override
	protected void setUp() {
		...
		//		"resources/sfca/rulesets/appexchange_apex/xml/AvoidHardcodedCredentialsInHttpHeader.xml"
		addRule("sfca/rulesets/AppExchange_apex.xml", "AvoidHardcodedCredentialsInHttpHeader");
	}
}
