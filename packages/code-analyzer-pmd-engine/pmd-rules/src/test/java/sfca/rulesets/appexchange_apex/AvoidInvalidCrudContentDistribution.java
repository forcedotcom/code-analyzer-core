...
public class AvoidInvalidCrudContentDistribution extends SimpleAggregatorTst {
	@Override
	protected void setUp() {
		...
		//		"resources/sfca/rulesets/appexchange_apex/xml/AvoidInvalidCrudContentDistribution.xml"
		addRule("sfca/rulesets/AppExchange_apex.xml", "AvoidInvalidCrudContentDistribution");
	}
}
