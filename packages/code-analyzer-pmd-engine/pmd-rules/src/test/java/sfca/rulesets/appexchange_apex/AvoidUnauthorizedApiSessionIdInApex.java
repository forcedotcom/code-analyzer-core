...
public class AvoidUnauthorizedApiSessionIdInApex extends SimpleAggregatorTst {
	@Override
	protected void setUp() {
		...
		//		"resources/sfca/rulesets/appexchange_apex/xml/AvoidUnauthorizedApiSessionIdInApex.xml"
		addRule("sfca/rulesets/AppExchange_apex.xml", "AvoidUnauthorizedApiSessionIdInApex");
	}
}
