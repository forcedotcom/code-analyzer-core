...
describe('Tests for the describeRules method of ESLintEngine', () => {
    ...
    const CSS_CONFIG_RULES: RuleDescription[] = loadRuleDescriptions('rules_OnlyCssBaseConfig.goldfile.json');
    const HTML_CONFIG_RULES: RuleDescription[] = loadRuleDescriptions('rules_OnlyHtmlBaseConfig.goldfile.json');
