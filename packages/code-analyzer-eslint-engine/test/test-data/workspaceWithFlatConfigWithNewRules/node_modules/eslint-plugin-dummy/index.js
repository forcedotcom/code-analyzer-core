module.exports = {
    rules: {
        ...
        "my-rule-7": { // This rule should not be included since it is marked as deprecated
            meta: {
                type: "suggestion",
                deprecated: true,
                docs: {
                    description: "My description of my-rule-7",
                    url: "https://example.com/my-rule-7"
                }
            },
            create: function (context) {
                return {} // no-op rule
        ...
        "my-rule-8": { // Again contains all information
            meta: {
                type: "problem",
                docs: {
                    description: "My description of my-rule-8",
                    url: "https://example.com/my-rule-8"
                }
            },
            create: function (context) {
                return {} // no-op rule
