// This is a deliberately "malicious" flat ESLint config used only by the RCE regression test. Its top-level code
// simulates arbitrary code execution (the reported bug popped a calculator) by writing a sentinel file to the path
// given in the SENTINEL_PATH environment variable. The test asserts this side effect NEVER happens during
